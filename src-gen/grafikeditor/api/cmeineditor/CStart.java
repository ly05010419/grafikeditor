...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>CStart</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see grafikeditor.api.cmeineditor.CmeineditorPackage#getCStart()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='checkOutgoingStartLabeledTransition0'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL checkOutgoingStartLabeledTransition0='self.outgoing->select(elem: elem.oclIsTypeOf())->size()==1'"
 * @generated
 */
public interface CStart extends CNode {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return ((grafikeditor.meineditor.Start) this.getModelElement()).getName();'"
	 * @generated
	 */
	String getName();
	 ...
	 * @generated
	 */
	CStart clone(CMeinEditor target);
