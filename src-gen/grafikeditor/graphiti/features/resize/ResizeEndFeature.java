...
public class ResizeEndFeature extends de.jabc.cinco.meta.core.ge.style.model.features.CincoAbstractResizeFeature {

	private grafikeditor.meineditor.End bo;

	public ResizeEndFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void resizeShape(final IResizeShapeContext context) {
		...
		dom.getCommandStack().execute(new RecordingCommand(dom, "Resize") {
			...
			protected void doExecute() {
				bo = (grafikeditor.meineditor.End) getBusinessObjectForPictogramElement(context.getPictogramElement());
				...
				try {	
					if (!isApiCall()) {
						...
						grafikeditor.api.cmeineditor.CEnd tmp = wrapped.findCEnd(bo);
