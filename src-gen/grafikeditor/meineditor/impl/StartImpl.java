 ...
 * <ul>
 *   <li>{@link grafikeditor.meineditor.impl.StartImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.StartImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.StartImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class StartImpl extends ModelElementImpl implements Start {
	/**
	...
	protected EClass eStaticClass() {
		return MeineditorPackage.Literals.START;
	}
	...
	public EList<Edge> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.START__INCOMING, GraphmodelPackage.EDGE__TARGET_ELEMENT);
		}
		return incoming;
	}
	...
	public EList<Edge> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.START__OUTGOING, GraphmodelPackage.EDGE__SOURCE_ELEMENT);
		}
		return outgoing;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MeineditorPackage.START__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MeineditorPackage.START__INCOMING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncoming()).basicAdd(otherEnd, msgs);
			case MeineditorPackage.START__OUTGOING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MeineditorPackage.START__OUTGOING:
				return getOutgoing();
			case MeineditorPackage.START__NAME:
				return getName();
		}
