 ...
 * <ul>
 *   <li>{@link grafikeditor.meineditor.Variable#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see grafikeditor.meineditor.MeineditorPackage#getVariable()
 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL checkIncomingVariableLabeledTransitionTransition0='(self.incoming->select(elem| elem.oclIsKindOf(Transition))->size())+(self.incoming->select(elem| elem.oclIsKindOf(LabeledTransition))->size())>=1' checkOutgoingVariableLabeledTransition0='(self.outgoing->select(elem| elem.oclIsKindOf(LabeledTransition))->size())>=1'"
 * @generated
 */
public interface Variable extends Node {
	 ...
	 * @see #setName(String)
	 * @see grafikeditor.meineditor.MeineditorPackage#getVariable_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link grafikeditor.meineditor.Variable#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
