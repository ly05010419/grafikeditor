...
public class TerminalEContentAdapter extends MeinEditorEContentAdapter{

	private static TerminalEContentAdapter instance;

	public static TerminalEContentAdapter getInstance() {
		if (instance == null) {
			instance = new TerminalEContentAdapter();
		}
		return instance;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		if (invalidFeature(featureName))
			return;
		if (o instanceof grafikeditor.meineditor.Terminal) {
