...
public class GatewayEContentAdapter extends MeinEditorEContentAdapter{

	private static GatewayEContentAdapter instance;

	public static GatewayEContentAdapter getInstance() {
		if (instance == null) {
			instance = new GatewayEContentAdapter();
		}
		return instance;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		if (invalidFeature(featureName))
			return;
		if (o instanceof grafikeditor.meineditor.Gateway) {
