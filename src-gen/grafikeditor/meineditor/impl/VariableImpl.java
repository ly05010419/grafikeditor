 ...
 * <ul>
 *   <li>{@link grafikeditor.meineditor.impl.VariableImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.VariableImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.VariableImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends ModelElementImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return MeineditorPackage.Literals.VARIABLE;
	}
	...
	public EList<Edge> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.VARIABLE__INCOMING, GraphmodelPackage.EDGE__TARGET_ELEMENT);
		}
		return incoming;
	}
	...
	public EList<Edge> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.VARIABLE__OUTGOING, GraphmodelPackage.EDGE__SOURCE_ELEMENT);
		}
		return outgoing;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MeineditorPackage.VARIABLE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MeineditorPackage.VARIABLE__INCOMING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncoming()).basicAdd(otherEnd, msgs);
			case MeineditorPackage.VARIABLE__OUTGOING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MeineditorPackage.VARIABLE__OUTGOING:
				return getOutgoing();
			case MeineditorPackage.VARIABLE__NAME:
				return getName();
		}
