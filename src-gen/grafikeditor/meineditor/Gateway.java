 ...
 * <ul>
 *   <li>{@link grafikeditor.meineditor.Gateway#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see grafikeditor.meineditor.MeineditorPackage#getGateway()
 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL checkIncomingGatewayLabeledTransitionTransition0='(self.incoming->select(elem| elem.oclIsKindOf(Transition))->size())+(self.incoming->select(elem| elem.oclIsKindOf(LabeledTransition))->size())>=1' checkOutgoingGatewayLabeledTransition0='(self.outgoing->select(elem| elem.oclIsKindOf(LabeledTransition))->size())>=1'"
 * @generated
 */
public interface Gateway extends Node {
	 ...
	 * @see #setName(String)
	 * @see grafikeditor.meineditor.MeineditorPackage#getGateway_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link grafikeditor.meineditor.Gateway#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
