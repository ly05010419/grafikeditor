...
public class ResizeVariableFeature extends de.jabc.cinco.meta.core.ge.style.model.features.CincoAbstractResizeFeature {

	private grafikeditor.meineditor.Variable bo;

	public ResizeVariableFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void resizeShape(final IResizeShapeContext context) {
		...
		dom.getCommandStack().execute(new RecordingCommand(dom, "Resize") {
			...
			protected void doExecute() {
				bo = (grafikeditor.meineditor.Variable) getBusinessObjectForPictogramElement(context.getPictogramElement());
				...
				try {	
					if (!isApiCall()) {
						...
						grafikeditor.api.cmeineditor.CVariable tmp = wrapped.findCVariable(bo);
