...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CEnd</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class CEndImpl extends CNodeImpl implements CEnd {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return CmeineditorPackage.Literals.CEND;
	}
	...
	public boolean canClone(final CMeinEditor target) {
		final CEnd clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCEnd();
	 ...
	 * @generated
	 */
	public CEnd clone(final CMeinEditor target) {
		final CEnd clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCEnd();
		org.eclipse.graphiti.mm.pictograms.PictogramElement copy = de.jabc.cinco.meta.core.ui.utils.CincoCopyUtils.flatCopy(getPictogramElement());
		clone.setPictogramElement(copy);
		clone.setModelElement((graphmodel.ModelElement) copy.getLink().getBusinessObjects().get(0));
