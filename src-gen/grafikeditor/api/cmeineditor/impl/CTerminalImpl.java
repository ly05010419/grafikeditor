...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CTerminal</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class CTerminalImpl extends CNodeImpl implements CTerminal {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected CTerminalImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CmeineditorPackage.Literals.CTERMINAL;
	}
	...
	public String getName() {
		return ((grafikeditor.meineditor.Terminal) this.getModelElement()).getName();
	}
	 ...
	 * @generated
	 */
	public EList<CGateway> getGatewayPredecessors() {
	 ...
	 * @generated
	 */
	public EList<CVariable> getVariablePredecessors() {
	...
	public boolean canClone(final CMeinEditor target) {
		final CTerminal clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCTerminal();
	 ...
	 * @generated
	 */
	public CTerminal clone(final CMeinEditor target) {
		final CTerminal clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCTerminal();
		org.eclipse.graphiti.mm.pictograms.PictogramElement copy = de.jabc.cinco.meta.core.ui.utils.CincoCopyUtils.flatCopy(getPictogramElement());
		clone.setPictogramElement(copy);
		clone.setModelElement((graphmodel.ModelElement) copy.getLink().getBusinessObjects().get(0));
