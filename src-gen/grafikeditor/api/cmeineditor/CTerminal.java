...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>CTerminal</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see grafikeditor.api.cmeineditor.CmeineditorPackage#getCTerminal()
 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL checkIncomingTerminalLabeledTransitionTransition0='self.incoming->select(elem: elem.oclIsTypeOf())->size()>=1' checkOutgoingTerminalLabeledTransition0='self.outgoingElements->select(elem: elem.oclIsTypeOf())->size()>=1'"
 * @generated
 */
public interface CTerminal extends CNode {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return ((grafikeditor.meineditor.Terminal) this.getModelElement()).getName();'"
	 * @generated
	 */
	String getName();
	 ...
	 * @generated
	 */
	CTerminal clone(CMeinEditor target);
