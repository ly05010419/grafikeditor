...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>CGateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class CGatewayImpl extends CNodeImpl implements CGateway {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected CGatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CmeineditorPackage.Literals.CGATEWAY;
	}
	...
	public String getName() {
		return ((grafikeditor.meineditor.Gateway) this.getModelElement()).getName();
	}
	...
	public boolean canClone(final CMeinEditor target) {
		final CGateway clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCGateway();
	 ...
	 * @generated
	 */
	public CGateway clone(final CMeinEditor target) {
		final CGateway clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCGateway();
		org.eclipse.graphiti.mm.pictograms.PictogramElement copy = de.jabc.cinco.meta.core.ui.utils.CincoCopyUtils.flatCopy(getPictogramElement());
		clone.setPictogramElement(copy);
		clone.setModelElement((graphmodel.ModelElement) copy.getLink().getBusinessObjects().get(0));
