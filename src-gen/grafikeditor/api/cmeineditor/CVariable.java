 ...
 *
 *
 * @see grafikeditor.api.cmeineditor.CmeineditorPackage#getCVariable()
 * @model annotation="http://www.eclipse.org/emf/2002/Ecore constraints='checkOutgoingVariableLabeledTransition0 checkIncomingVariableLabeledTransitionTransition0'"
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL checkIncomingVariableLabeledTransitionTransition0='self.incoming->select(elem: elem.oclIsTypeOf())->size()>=1' checkOutgoingVariableLabeledTransition0='self.outgoingElements->select(elem: elem.oclIsTypeOf())->size()>=1'"
 * @generated
 */
public interface CVariable extends CNode {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel body='return ((grafikeditor.meineditor.Variable) this.getModelElement()).getName();'"
	 * @generated
	 */
	String getName();
	 ...
	 * @generated
	 */
	CVariable clone(CMeinEditor target);
