...
public class EndEContentAdapter extends MeinEditorEContentAdapter{

	private static EndEContentAdapter instance;

	public static EndEContentAdapter getInstance() {
		if (instance == null) {
			instance = new EndEContentAdapter();
		}
		return instance;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		if (invalidFeature(featureName))
			return;
		if (o instanceof grafikeditor.meineditor.End) {
