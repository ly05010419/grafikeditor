...
public class ResizeStartFeature extends de.jabc.cinco.meta.core.ge.style.model.features.CincoAbstractResizeFeature {

	private grafikeditor.meineditor.Start bo;

	public ResizeStartFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void resizeShape(final IResizeShapeContext context) {
		...
		dom.getCommandStack().execute(new RecordingCommand(dom, "Resize") {
			...
			protected void doExecute() {
				bo = (grafikeditor.meineditor.Start) getBusinessObjectForPictogramElement(context.getPictogramElement());
				...
				try {	
					if (!isApiCall()) {
						...
						grafikeditor.api.cmeineditor.CStart tmp = wrapped.findCStart(bo);
