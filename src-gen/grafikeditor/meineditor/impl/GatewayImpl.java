 ...
 * <ul>
 *   <li>{@link grafikeditor.meineditor.impl.GatewayImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.GatewayImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link grafikeditor.meineditor.impl.GatewayImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GatewayImpl extends ModelElementImpl implements Gateway {
	/**
	...
	protected EClass eStaticClass() {
		return MeineditorPackage.Literals.GATEWAY;
	}
	...
	public EList<Edge> getIncoming() {
		if (incoming == null) {
			incoming = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.GATEWAY__INCOMING, GraphmodelPackage.EDGE__TARGET_ELEMENT);
		}
		return incoming;
	}
	...
	public EList<Edge> getOutgoing() {
		if (outgoing == null) {
			outgoing = new EObjectWithInverseResolvingEList<Edge>(Edge.class, this, MeineditorPackage.GATEWAY__OUTGOING, GraphmodelPackage.EDGE__SOURCE_ELEMENT);
		}
		return outgoing;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MeineditorPackage.GATEWAY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MeineditorPackage.GATEWAY__INCOMING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncoming()).basicAdd(otherEnd, msgs);
			case MeineditorPackage.GATEWAY__OUTGOING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MeineditorPackage.GATEWAY__OUTGOING:
				return getOutgoing();
			case MeineditorPackage.GATEWAY__NAME:
				return getName();
		}
