...
public class ResizeGatewayFeature extends de.jabc.cinco.meta.core.ge.style.model.features.CincoAbstractResizeFeature {

	private grafikeditor.meineditor.Gateway bo;

	public ResizeGatewayFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void resizeShape(final IResizeShapeContext context) {
		...
		dom.getCommandStack().execute(new RecordingCommand(dom, "Resize") {
			...
			protected void doExecute() {
				bo = (grafikeditor.meineditor.Gateway) getBusinessObjectForPictogramElement(context.getPictogramElement());
				...
				try {	
					if (!isApiCall()) {
						...
						grafikeditor.api.cmeineditor.CGateway tmp = wrapped.findCGateway(bo);
