 ...
 * @generated
 */
public class CVariableImpl extends CNodeImpl implements CVariable {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return CmeineditorPackage.Literals.CVARIABLE;
	}
	...
	public String getName() {
		return ((grafikeditor.meineditor.Variable) this.getModelElement()).getName();
	}
	...
	public boolean canClone(final CMeinEditor target) {
		final CVariable clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCVariable();
	 ...
	 * @generated
	 */
	public CVariable clone(final CMeinEditor target) {
		final CVariable clone = grafikeditor.api.cmeineditor.CmeineditorFactory.eINSTANCE.createCVariable();
		org.eclipse.graphiti.mm.pictograms.PictogramElement copy = de.jabc.cinco.meta.core.ui.utils.CincoCopyUtils.flatCopy(getPictogramElement());
		clone.setPictogramElement(copy);
		clone.setModelElement((graphmodel.ModelElement) copy.getLink().getBusinessObjects().get(0));
