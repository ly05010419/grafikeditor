...
public class DeleteLabeledTransitionFeature extends de.jabc.cinco.meta.core.ui.features.CincoDeleteFeature {

	public DeleteLabeledTransitionFeature(IFeatureProvider fp) {
		super(fp);
