...
public class StartEContentAdapter extends MeinEditorEContentAdapter{

	private static StartEContentAdapter instance;

	public static StartEContentAdapter getInstance() {
		if (instance == null) {
			instance = new StartEContentAdapter();
		}
		return instance;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		if (invalidFeature(featureName))
			return;
		if (o instanceof grafikeditor.meineditor.Start) {
