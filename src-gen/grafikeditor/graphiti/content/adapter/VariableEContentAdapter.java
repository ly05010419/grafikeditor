...
public class VariableEContentAdapter extends MeinEditorEContentAdapter{

	private static VariableEContentAdapter instance;

	public static VariableEContentAdapter getInstance() {
		if (instance == null) {
			instance = new VariableEContentAdapter();
		}
		return instance;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		if (invalidFeature(featureName))
			return;
		if (o instanceof grafikeditor.meineditor.Variable) {
